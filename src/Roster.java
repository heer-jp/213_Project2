...
public class Roster {
    ...
    /**
     * Checks if student can receiev financial aid by verifying if student is a resident.
    ...
    /**
     * Prints all students in student roster as is
     */
    public void print() {
        if (size != 0) {
    ...
    /**
     * Calcualtes tution of all students in student roster
     */
