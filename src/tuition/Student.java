...
public class Student {
    ...
    public static final double DEFAULT_FEE = 0;
    ...
    /**
     * Calculates the tuition due for a student.
     */
    ...
    public String toString() {
        ...
        if (this.lastPaymentDate == null) {
            return profile.toString() + ":" + credits + " credit hours:tuition due" + String.format("%.2f", tuition)
                    + ":last payment:" + String.format("%.2f", lastPaymentAmount) + ":payment date: " + " --/--/--";
        }
        return profile.toString() + ":" + credits + " credit hours:tuition due" + String.format("%.2f", tuition)
                + ":last payment:" + String.format("%.2f", lastPaymentAmount) + ":payment date: "
    ...
    /**
     * Compares student objects by profile.
     * @return returns true if the profile objects are equal, false otherwise 
     */
    @Override
